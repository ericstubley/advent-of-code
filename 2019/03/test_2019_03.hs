...
testIntersections = TestCase $ do
    Just (a, b) <- parseInput wiresP "03/test_input_1.txt"
    [(3, 3), (6, 5)] @=? intersections a b


testDists :: Test
testDists = TestCase $ do
    Just (a1, b1) <- parseInput wiresP "03/test_input_1.txt"
    Just (a2, b2) <- parseInput wiresP "03/test_input_2.txt"
    Just (a3, b3) <- parseInput wiresP "03/test_input_3.txt"
